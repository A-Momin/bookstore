...
class TestProductsModel(TestCase):
    def setUp(self):
        ...
        self.data1 = Product.objects.create(category_id=1, title='Django Unleashed', created_by_id=1, slug='django-unleashed', price='19.99', image='django')
    ...
    def test_products_model_entry(self):
        ...
        self.assertEqual(str(data), 'Django Unleashed')
    ...
    #     self.assertEqual(url, '/django-unleashed/')
    #     response = self.client.post(
