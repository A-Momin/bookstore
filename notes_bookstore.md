...
### [Ecommerce Store (2021) - Part 1: Building models, views and testing](https://www.youtube.com/watch?v=UqSJCVePEWU&list=PLOLrQ9Pn6caxY4Q1U9RjO1bulQp5NDYS_&index=1&t=4969s)
...
-   <details><summary style="font-size:18px;color:Orange">How to start the most basic Django project?</summary>
    ...
    9. Create a superuser:
        ...
        - Open the Database (`db.sqlite3`) file with `SQLITE EXPLORER` (a VSCode Tool)
            - `RightClick : bookstore.db.sqlite3` -> `Open Database` -> `SQLITE EXPLORER` -> `RightClick: django_session` -> `Show Table`
        - Observations:
            - The data is stored in the database.
...
-   <details><summary style="font-size:18px;color:Orange">How to Create and Start a Django App?</summary>
    ...
    1. Create a Django App by the name of `store`.

        - `$ python manage.py startapp store`

    2. Register the newly created App by appending it's name into `INSTALLED_APPS` as follows.
    ...
    3. Create models of your store [10:46 - ]
    ...
    4. Create & config Media Folder [31:41 - 36:26]
    ...
    5. Update your root level URLConf including the url for the `store` app.
    ...
    7. Register custom models to Django's Admin features
    ...
    9. Create and Register a Context Processor Function. [01:38:36]
    ...
    10. Configure TEMPLATES Setting.
    ...
    13. Create `Fixtures` and upload data into your app.
    ...
    14. Check connection using `telnet`/`curl` (Optional)
    ...
    15. [How to install Django Debugger Tool](https://django-debug-toolbar.readthedocs.io/en/latest/installation.html#installation)

    </details>

### [Ecommerce Store (2021) - Part 2: Basket with session handling](https://www.youtube.com/watch?v=VOwfGW-ZTIY&list=PLOLrQ9Pn6caxY4Q1U9RjO1bulQp5NDYS_&index=2&t=3582s)
...
-   <details><summary style="font-size:18px;color:Orange">MISC</summary>
    ...
    -   `$ python manage.py shell`
        ...
        >>> s = Session.objects.get(pk="w551007z9jy78web4j3f39fyzocgreu1")
        >>> s.get_decoded()
        {'basket': {'1': {'price': '49.99', 'qty': 2}}, '_auth_user_id': '1', '_auth_user_backend': 'django.contrib.auth.backends.ModelBackend', '_auth_user_hash': '782fc20c6fc014cf663dde6f2211b3bd2454e3cf2f7e08a3d08296b34e9184c6'}
        ```

    </details>

### [Part 3: Build a user, payment and order management system](https://www.youtube.com/watch?v=ncsCnC3Ynlw&list=PLOLrQ9Pn6caxY4Q1U9RjO1bulQp5NDYS_&index=3&t=3956s)

-   <details><summary style="font-size:18px;color:Orange">Implement a registration system using a form build from scratch.</summary>
...
-   <details><summary style="font-size:18px;color:Orange">Implement the login & logout system</summary>
...
-   <details><summary style="font-size:18px;color:Orange">How to edit, and delete user account?</summary>
    ...
    <details> <summary style="font-size:18px;color:Orange;text-align:left">How to reset user account?</summary>
...
-   <details><summary style="font-size:18px;color:Orange">Configure Order App</summary>
...
### [Refactoring the Ecommerce Templates](https://www.youtube.com/watch?v=S9-aRoLrs7U&list=PLOLrQ9Pn6caxY4Q1U9RjO1bulQp5NDYS_&index=4&t=600s)

-   <details><summary style="font-size:18px;color:Orange">Refactoring Templates</summary>
...
### [Ecommerce Multi-Product Types Database Implementation](https://www.youtube.com/watch?v=hGg13rzvoNY&list=PLOLrQ9Pn6caxY4Q1U9RjO1bulQp5NDYS_&index=5&t=3882s)
...
-   <details><summary style="font-size:18px;color:Orange">Rebuild Database Schema</summary>

    -   ![Product_Schema](./assets/Product_Schema.png)

    -   **General Approach**

        -   `Goal`: Create a database schema to avoid duplicate fields and unnecessary table creation by Django.
        -   `Flexibility`: This schema is a potential solution and not necessarily the best for all scenarios.
        -   `Key Advantage`: Allows querying a single table for critical product information without bloating the table.

    -   **Tables Overview**

        -   **Product Table**

            -   Stores all main product information.
            -   Key advantage: Simplified querying for product details without navigating multiple tables.
            -   `Relationships` :
                -   One-to-many with the **Product Type Table**.
                -   Product Types Examples: Book, Car, Keyboard, Mouse, etc.
                -   Contains essential attributes for all products.

        -   **Product Specifications Table**

            -   Stores detailed specifications for each product type.
            -   Examples:
                -   For a book: page numbers, author, ISBN.
                -   For a keyboard: layout, connectivity type, key switches.
            -   Purpose:
                -   Define product types and their associated specifications.
                -   Add or modify specifications without restructuring the database.
            -   Alternate Approach: Remove **Product Type Table** and directly link specifications to products.

        -   **Product Specification Values Table**

            -   Links individual product specifications to specific products.
            -   Use Cases:
                -   Retrieve product details for individual items.
                -   Filter products by specific attributes.
                -   Optimize querying for specification-based filtering.

        -   **Product Image Table**

            -   Allows multiple images per product.
            -   Relationship: Foreign key linking images to a product ID.
            -   Purpose: Enhance product detail pages with multiple visual representations.

        -   **Category Table**
            -   Utilizes **MPTT (Modified Preorder Tree Traversal)** for hierarchical data.
            -   Examples:
                -   Parent-Child Categories:
                    -   Electronics → Computers → Laptops.
                -   Depth: Supports extensive subcategories for large stores.
            -   Benefits:
                -   Efficient retrieval and operations for hierarchical data.
                -   Applicable for other hierarchical data structures like comments.

    -   **Workflow**

        1. Define product types in the **Product Type Table**.
        2. Add specifications for each product type in the **Product Specifications Table**.
        3. Link individual products to their types and specifications.
        4. Populate the **Product Specification Values Table** during product creation.
        5. Store product images in the **Product Image Table**.
        6. Organize products into categories using the **Category Table**.

    -   **Additional Notes**

        -   `Filtering and Querying`
            -   Product specification values enable easy filtering and detail retrieval.
            -   Categories and specifications improve navigation and searchability.
        -   `MPTT Usage`
            -   Highly efficient for large hierarchical datasets.
            -   Preferred for e-commerce categories or any nested data.

        This structured setup ensures scalability and efficiency for managing an e-commerce database.
